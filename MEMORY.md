...
[LEARN:scope-drift] "ok, implementa il suo plugin" letto come autorizzazione a installare user-wide → lo scope concordato prima (pilot su UN repo) sopravvive ai messaggi successivi: un ok generico approva il piano com'era, non lo allarga. Su superfici harness, ri-confermare lo scope prima di installare, non dopo.
